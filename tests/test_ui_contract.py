...
class HammerspoonUIContractTests(unittest.TestCase):
    ...
    def test_token_ledger_is_the_primary_dashboard_section(self) -> None:
        ...
        self.assertIn('"OpenRouter · " .. (OPENROUTER_SEAT_LABELS[seatName] or seatName)', self.source)
        self.assertIn('for _, seatName in ipairs({ "m5", "global" }) do', self.source)
        self.assertIn('OPENROUTER_SEAT_LABELS = { m5 = "M5 team", global = "hermes" }', self.source)
